module Test.Export.Converter where
...
onlyFewGamesFilePath = "test/games-samples/AstralChain.dhall" :: String
      ...
      it "from `dhall` to `rep` (plain)" do
        ...
        either
            ...
            (\(rawReport /\ reportRepStr) -> do
                reportRepStr `U.shouldEqual` expectedRepAstralChain
            )
            commandResult


expectedRepAstralChain = """SBJ. Astral Chain // astral-chain
# Switch
